...
class ATMainWindow(QtGui.QMainWindow):
   ...
   def setPlaceOrderLayout(self, PlaceOrderLayout):
      ...
      #self.buyBalanceLabel.setStyleSheet('color: rgb(167,174,186,100);')
      #self.buyBalanceAmountLabel.setStyleSheet('color: rgb(167,174,186,100);')
      ...
      buyPriceInput = QtGui.QLineEdit()
      #buyPriceInput.setTextMargins(3,3,3,3)
      #buyPriceInput.setStyleSheet('border: 1px solid rgb(255,255,255,200);')
      buyPriceInput.setValidator(QtGui.QDoubleValidator(0, 100000.0, 2))

      buyAmountLabel = QtGui.QLabel('Amount:')
      buyAmountInput = QtGui.QLineEdit()
      #buyAmountInput.setTextMargins(3,3,3,3)
      #buyAmountInput.setStyleSheet('border: 1px solid white')

      buyTotalLabel = QtGui.QLabel('Total:')
      buyTotalValueLabel = QtGui.QLabel()
      buyTotalLabel.setMargin(3)

      buyButton = QtGui.QPushButton()
      buyButton.setMinimumHeight(30)
      buyButton.setText('BUY')
      buyButton.setStyleSheet('background-color: rgb(0,255,0,180); font: bold 16px;')
      ...
      self.ctPlaceOrderBuyLayout.addWidget(buyPriceInput, 2, 1)
      self.ctPlaceOrderBuyLayout.addWidget(buyAmountLabel, 3, 0)
      self.ctPlaceOrderBuyLayout.addWidget(buyAmountInput, 3, 1)
      self.ctPlaceOrderBuyLayout.addWidget(buyTotalLabel, 4, 0)
      self.ctPlaceOrderBuyLayout.addWidget(buyTotalValueLabel, 4, 1)
      self.ctPlaceOrderBuyLayout.addWidget(buyButton, 5, 1)
      #self.ctPlaceOrderBuyLayout.addWidget(buyButton, 5, 0, 1, 2)
      ...
      p1 = pg.PlotWidget()
      p1.plot(np.random.normal(size=100), pen=(255, 0, 0), name="Red curve")
      self.ctPlaceOrderSellLayout.addWidget(p1)
